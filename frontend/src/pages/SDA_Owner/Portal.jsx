...
function SDAOwnerPortal() {
  ...
  const pageConfig = {
    ...
    accommodations: {title: "Manage Accommodations",component: ManageAccommodations,},
    availability: { title: "Availability", component: Availability },
    enquiry: { title: "Enquiry", component: Enquiry },
    booking: { title: "Booking", component: Booking },
  };
