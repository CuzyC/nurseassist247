...
import SettingsModal from "@/components/modal/AccountSettingsModal";

function Header({ pageTitle, openSettings }) {
            ...
            <div className="hidden sm:flex items-center gap-4 text-gray-700">
                ...
                <div className="flex items-center gap-3">
                    <button className="p-2 rounded-full bg-[#D2138C] hover:bg-[#D2138C] transition cursor-pointer">
                        <Settings onClick={() => handleSettings()} className="h-5 w-5 text-white" />
                    </button>
                </div>
            </div>
